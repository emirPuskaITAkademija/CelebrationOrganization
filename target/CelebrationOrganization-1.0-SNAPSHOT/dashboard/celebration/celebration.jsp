...
<%@page import="org.celebration.celebrationorganization.ejb.celebration.entity.Celebration"%>
        ...
        <form action="<%=action%>" method="post" class="row g-3 needs-validation" novalidate>
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input id="celebrationName" type="text" id="name"
            ...
            <div class="col-md-4">
                <div class="form-outline">
                    ...
                    <input id="celebrationDate" type="date"
