<%@page import="org.celebration.celebrationorganization.user.session.UserSession" %>
<%@page import="org.celebration.celebrationorganization.ejb.user.entity.User" %>
<%@page import="org.celebration.celebrationorganization.ejb.user.entity.Privilege" %>
...
<%
    ...
    Privilege userSessionPrivilege = sessionUser.getPrivilege();
%>
...
<div style="padding: 20px">
    ...
    <div class="responsive">
        <div class="gallery">
            <a target="_blank"
               href="https://th.bing.com/th/id/R.976385bae6492fbe38e281d45586d0cc?rik=5wK3QjpyG3gueQ&pid=ImgRaw&r=0&sres=1&sresct=1">
